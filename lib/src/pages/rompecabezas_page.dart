...
import 'package:triva_app/src/magic/GameEngine.dart';
import 'package:triva_app/src/magic/GamePainter.dart';
import 'package:triva_app/src/magic/ImageNode.dart';
import 'package:triva_app/src/magic/PuzzleMagic.dart';

// Código tomado de https://github.com/zuijinbuzai/flutter_puzzle

class RompecabezasPage extends StatefulWidget {
  final Size size;
  final String imgPath;
  final int level;
  RompecabezasPage(this.size, this.imgPath, this.level);

  @override
  State<StatefulWidget> createState() {
    return RompecabezasPageState(size, imgPath, level);
  }
}
...
class RompecabezasPageState extends State<RompecabezasPage>
  ...
  RompecabezasPageState(this.size, this.path, this.level) {
    puzzleMagic = PuzzleMagic();
      ...
      return Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            Text("Has descubierto la chorrera del indio 😎"),
            SizedBox(height: 20.0),
            Image(image: AssetImage('assets/img/puzzle.jpg'), fit: BoxFit.fitWidth),
            SizedBox(height: 20.0),
            RaisedButton(
